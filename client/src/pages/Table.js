...
const Table = () => {
  ...
  useEffect(() => {
    dispatch(getFilterDataAsync(dataValue));
  }, [dataValue]);

  return (
    <>
      <h1 className="text-4xl font-bold text-center mb-8 mt-5">Details</h1>
      <div className="flex justify-between items-center max-sm:flex-col max-sm:gap-5 max-sm:flex-col-reverse px-[4rem]">
        {/* DropDown  */}
        <div>
          <Link
            to="/add"
        ...
        <div className="flex gap-2  align-middle">
          ...
          >
            ...
            <option value="desec">Z to A</option>
          </select>
        </div>
        <div className="flex gap-2  align-middle">
          <select
